...
class RiskCharts:
    ...
    def create_risk_distribution_chart(cls, profiles: List[RiskProfile]) -> FigureCanvas:
        ...
        ax.set_xlabel('Risk Score', color=cls.COLORS['text'], fontsize=12, fontweight='bold')
        ax.set_ylabel('Number of Policies', color=cls.COLORS['text'], fontsize=12, fontweight='bold')
        ax.set_title('Risk Score Distribution', color=cls.COLORS['title'], fontsize=14, fontweight='bold')
    ...
    def create_pie_chart(cls, summary: PortfolioSummary) -> FigureCanvas:
        ...
        ax.set_title('Risk Level Distribution', color=cls.COLORS['title'], fontsize=14, fontweight='bold', pad=20)
        fig.tight_layout()
    ...
    def create_loss_distribution_chart(cls, loss_samples: np.ndarray, var_95: float, var_99: float) -> FigureCanvas:
        ...
        ax.set_xlabel('Loss (DZD)', color=cls.COLORS['text'], fontsize=12, fontweight='bold')
        ax.set_ylabel('Probability Density', color=cls.COLORS['text'], fontsize=12, fontweight='bold')
        ax.set_title('Loss Distribution - Monte Carlo Simulation', color=cls.COLORS['title'], fontsize=14, fontweight='bold')
    ...
    def create_wilaya_exposure_chart(cls, wilaya_exposure: Dict[str, float]) -> FigureCanvas:
        ...
        ax.set_xlabel('Total Insured Capital (DZD)', color=cls.COLORS['text'], fontsize=12, fontweight='bold')
        ax.set_ylabel('Wilaya', color=cls.COLORS['text'], fontsize=12, fontweight='bold')
        ax.set_title('Top 10 Wilayas by Insurance Exposure', color=cls.COLORS['title'], fontsize=14, fontweight='bold')
