"""
محمل البيانات (نسخة محسنة كاملة)
Data Loader (Full Optimized Version)
"""
...
class DataLoader:
    ...
    def detect_sheet_name(cls, file_path: str) -> List[str]:
        ...
        Detect Available Sheet Names in File
    ...
    def get_recommended_sheet(cls, file_path: str) -> str:
        ...
        Get Recommended Sheet for Loading
        
        الأولوية:
        1. أوراق تحتوي على '2023' أو '2024' أو '2025'
        2. أوراق تحتوي على 'data' أو 'Data'
        3. الورقة الأولى
        """
    ...
    @classmethod
    def _estimate_floors(cls, capital_assure, type_text) -> int:
        """تقدير عدد الطوابق"""
        try:
    ...
    def load_from_excel(
        ...
        Args:
            ...
            progress_callback: دالة تحديث التقدم (progress, message)
        ...
        try:
            # اكتشاف اسم الورقة إذا لم يتم تحديده
            ...
            for batch_num in range(batches):
                ...
                for _, row in batch_df.iterrows():
                    try:
                        ...
                        capital_assure = cls._clean_numeric(capital_str)
                        
                        if capital_assure <= 0:
                            zero_capital += 1
                            continue
                        
                        building_type, structure_type = cls._infer_types(type_str, capital_assure)
                        floors = cls._estimate_floors(capital_assure, type_str)
    ...
    def get_statistics(cls, profiles: List[RiskProfile]) -> Dict[str, Any]:
        ...
        return {
            ...
            'avg_insured': total_insured / len(profiles) if profiles else 0,
